...
class DataOpsPipeline(Base):
    ...
    pipeline_key: Mapped[str | None] = mapped_column(String(120), unique=True, nullable=True, index=True)
    pipeline_type: Mapped[str | None] = mapped_column(String(80), nullable=True)
...
class DataOpsPipelineRun(Base):
    ...
    databricks_run_id: Mapped[str | None] = mapped_column(String(80), nullable=True, index=True)
    business_run_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    ...
    metrics_json: Mapped[list[dict]] = mapped_column(JSON, default=list, nullable=False)
