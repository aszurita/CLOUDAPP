...
1. Open the Azure Static Web Apps URL.
2. Show that the dashboard loads platform telemetry from the FastAPI backend.
3. Open the backend `/health` endpoint and show database status.
4. Show environments: DEV, QA, and PROD.
