...
| `FRONTEND_ORIGINS` | yes | Comma-separated CORS origins, for example `http://localhost:5173`. |
...
| Variable | Required | Description |
| --- | --- | --- |
| `VITE_API_BASE_URL` | yes | Public backend URL, for example `https://ca-cloudapp-dev-api...azurecontainerapps.io`. |
